...
import TylerResume from '../tyler_resume/tyler_resume.js';
...
class ResultMain extends React.Component {
	...
	toggleResume (e) {
		e.preventDefault();
		let current = this.state.displayResume;
		this.setState({
			displayResume: !current
		})
		console.log(current);
	} 
		...
		return (
			...
			<div className="ResultMain">
				...
				<div className="images-container">
					<h3><a href="" onClick={this.toggleResume}>Resume for Tyler Cookson</a></h3>
					<TylerResume display={this.state.displayResume}/>
